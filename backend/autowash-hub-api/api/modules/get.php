    ...
    private function ensureFeedbackEnhancements() {
        ...
        public function get_monthly_bookings_range() {
            try {
                ...
                return $this->sendPayload(
                    ...
                    "success",
                    "Monthly bookings for date range retrieved successfully",
                    200
                );
            } catch (\PDOException $e) {
                return $this->sendPayload(
        ...
        public function get_weekly_revenue_range() {
            try {
                ...
                $sql = "SELECT 
                            WEEK(wash_date) as week,
                            DATE_FORMAT(DATE_SUB(wash_date, INTERVAL DAYOFWEEK(wash_date)-1 DAY), '%Y-%m-%d') as week_start_date,
